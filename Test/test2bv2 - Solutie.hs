...
-- varianta cu 18 simboluri
--suggestionsRating s = map (foldr (max) 0) $ map (allOverlapsRatings s) dict
-- varianta cu 11 simboluri
suggestionsRating str = map (maximum . allOverlapsRatings str) dict
...
yy :: [(Int, Int)]
yy = [(2,1), (2,3), (2,0), (4,2), (5,4)]
-- exemplu: insertPg (4,7) yy == [(2,1), (2,3), (2,0), (4,2), (4,7), (5,4)]
--          insertPg (3,7) yy == [(2,1), (2,3), (2,0), (3,7), (4,2), (5,4)]
