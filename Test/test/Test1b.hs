...
-- incarcati fisierul pe linkul acesta: https://sendtomycloud.com/test342b
...
--     Prim 4 == False
prim :: Int -> Bool
prim ele = prim2 ele prime

prim2 :: Int -> [Int] -> Bool
prim2 elem [] = False
prim2 elem (xs:primee) = if (xs == elem) then True else prim2 elem(primee)
...
-- 	enc 6 == "17"
-- 	enc 802 == "2925"     "29" + "2" + "5"
-- 	enc 1239 == "35739"   "3" + "5" + "7" + "39"
-- 	enc 9876543210 == "3929191713117532"  
enc :: Int -> String
...
-- (16 simboluri)
-- exemplu:
-- encmsg [1,2,3,-3,91,-1,24,-2,13] == "35739351137"
encmsg :: [Int] -> String
...
lung :: [String] -> Int
lung xs = foldr max 0 (map length (filter (\x -> x!!0 == 'c') xs))